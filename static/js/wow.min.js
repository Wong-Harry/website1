...
;(function () {
  ...
  ;(i = (function () {
    function b() {}
    return (
      (b.prototype.extend = function (e, f) {
        var g, o
        for (g in f) {
      ...
      (b.prototype.createEvent = function (f, g, o, p) {
        ...
        return (
          ...
          null != document.createEvent
            ? ((q = document.createEvent('CustomEvent')), q.initCustomEvent(f, g, o, p))
            : null != document.createEventObject
            ? ((q = document.createEventObject()), (q.eventType = f))
            : (q.eventName = f),
          q
        )
      }),
      ...
      (b.prototype.removeEvent = function (d, e, f) {
        return null != d.removeEventListener
    ...
    (this.WOW = (function () {
      ...
      return (
        ...
        (a.prototype.applyStyle = function (f, g) {
          var o, p, q
          return (
            (p = f.getAttribute('data-wow-duration')),
        ...
        (a.prototype.resetAnimation = function (c) {
          var d
          return c.type.toLowerCase().indexOf('animationend') >= 0
            ? ((d = c.target || c.srcElement), (d.className = d.className.replace(this.config.animateClass, '').trim()))
            : void 0
        }),
        (a.prototype.customStyle = function (f, g, o, p, q) {
          return (
            ...
            o && this.vendorSet(f.style, { animationDuration: o }),
            p && this.vendorSet(f.style, { animationDelay: p }),
            q && this.vendorSet(f.style, { animationIterationCount: q }),
            this.vendorSet(f.style, { animationName: g ? 'none' : this.cachedAnimationName(f) }),
            f
          )
        }),
        ...
        (a.prototype.isVisible = function (g) {
          var o, p, q, r, s
          return (
            (p = g.getAttribute('data-wow-offset') || this.config.offset),
