...
!(function (b) {
  'function' == typeof define && define.amd
    ? define(['jquery'], b)
    : b('object' == typeof exports ? require('jquery') : window.jQuery || window.Zepto)
})(function (V) {
  var X,
    Z,
    ab,
    ...
    aP = function (a, b) {
      X.ev.triggerHandler(ay + a, b),
        X.st.callbacks &&
          ((a = a.charAt(0).toLowerCase() + a.slice(1)), X.st.callbacks[a] && X.st.callbacks[a].apply(X, V.isArray(b) ? b : [b]))
    },
    aQ = function (a) {
      return (
        (a === ah && X.currTemplate.closeBtn) ||
          ((X.currTemplate.closeBtn = V(X.st.closeMarkup.replace('%title%', X.st.tClose))), (ah = a)),
  ...
  ;(aI.prototype = {
    ...
    open: function (a) {
      ...
      ;(X.types = []),
        ...
        a.key ? (X.popupsCache[a.key] || (X.popupsCache[a.key] = {}), (X.currTemplate = X.popupsCache[a.key])) : (X.currTemplate = {}),
        ...
        X.st.modal && ((X.st.closeOnContentClick = !1), (X.st.closeOnBgClick = !1), (X.st.showCloseBtn = !1), (X.st.enableEscapeKey = !1)),
        X.bgOverlay ||
      ...
      aP('BeforeOpen'),
        ...
        X.fixedContentPos
          ? X.wrap.css({ overflow: X.st.overflowY, overflowX: 'hidden', overflowY: X.st.overflowY })
          : X.wrap.css({ top: aM.scrollTop(), position: 'absolute' }),
        (X.st.fixedBgPos === !1 || ('auto' === X.st.fixedBgPos && !X.fixedContentPos)) &&
    ...
    addGroup: function (b, f) {
      ...
      ;(f.mainEl = b),
        f.items
          ...
          : ((f.isObj = !1), f.delegate ? b.off(h).on(h, f.delegate, g) : ((f.items = b), b.off(h).on(h, g)))
    },
          ...
          if (((h = b.split('_')), h.length > 1)) {
            ...
            if (i.length > 0) {
              ...
              'replaceWith' === j
                ...
                ? i.is('img')
                  ? i.attr('src', e)
                  : i.replaceWith(V('<img>').attr('src', e).attr('class', i.attr('class')))
                : i.attr(h[1], e)
            }
          } else {
            a.find(aA + '-' + b).html(e)
      ...
      getInline: function (a, b) {
        if ((ai(), a.src)) {
          ...
          if (i.length) {
            ...
            j &&
              j.tagName &&
              (ac || ((aa = h.hiddenClass), (ac = aO(aa)), (aa = 'mfp-' + aa)), (ae = i.after(ac).detach().removeClass(aa))),
    ...
    proto: {
      ...
      _onImageHasSize: function (b) {
        b.img &&
          ...
          aP('ImageHasSize', b),
          b.imgHidden && (X.content && X.content.removeClass('mfp-loading'), (b.imgHidden = !1)))
      },
            ...
            at && clearInterval(at),
              (at = setInterval(function () {
                return g.naturalWidth > 0
                  ...
                  : (f > 200 && clearInterval(at), f++, void (3 === f ? h(10) : 40 === f ? h(50) : 100 === f && h(500)))
              }, a))
          }
        h(1)
      },
      getImage: function (a, b) {
        var k = 0,
          l = function () {
            a &&
              (a.img[0].complete
                ? (a.img.off('.mfploader'),
                  a === X.currItem && (X._onImageHasSize(a), X.updateStatus('ready')),
                  (a.hasSize = !0),
                  (a.loaded = !0),
          ...
          m = function () {
            a &&
              (a.img.off('.mfploader'),
              a === X.currItem && (X._onImageHasSize(a), X.updateStatus('error', n.tError.replace('%url%', a.src))),
              (a.hasSize = !0),
              (a.loaded = !0),
              (a.loadError = !0))
          },
        ...
        return (
          ...
          a.hasSize
            ? (at && clearInterval(at),
              a.loadError
                ? (b.addClass('mfp-loading'), X.updateStatus('error', n.tError.replace('%url%', a.src)))
                : (b.removeClass('mfp-loading'), X.updateStatus('ready')),
              b)
            : (X.updateStatus('loading'),
              (a.loading = !0),
              a.hasSize || ((a.imgHidden = !0), b.addClass('mfp-loading'), X.findImageSize(a)),
              b)
        )
      },
    },
  ...
  V.magnificPopup.registerModule('zoom', {
    ...
    proto: {
      ...
      _getOffset: function (a) {
        ...
        return (
          az() ? (l['-moz-transform'] = l.transform = 'translate(' + i.left + 'px,' + i.top + 'px)') : ((l.left = i.left), (l.top = i.top)),
          l
        )
      },
    },
      ...
      getIframe: function (a, b) {
        ...
        V.each(i.patterns, function () {
          return h.indexOf(this.index) > -1
            ? (this.id &&
                (h = 'string' == typeof this.id ? h.substr(h.lastIndexOf(this.id) + this.id.length, h.length) : this.id.call(this, h)),
